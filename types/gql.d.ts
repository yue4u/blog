...
export type FileFieldsEnum =
  ...
  | 'childrenMdx___frontmatter___speaker'
  | 'childrenMdx___slug'
  | 'childrenMdx___body'
  ...
  | 'childMdx___frontmatter___speaker'
  | 'childMdx___slug'
  | 'childMdx___body'
  | 'childMdx___excerpt'
  | 'childMdx___headings'
...
export type NoteArchiveQueryQuery = { allDirectory: { edges: Array<{ node: Pick<Directory, 'id' | 'name' | 'modifiedTime'> }> } };
...
export type Unnamed_2_Query = { mdx?: Maybe<(
  ...
  )>, sideBar: { edges: Array<{ node: (
        Pick<Mdx, 'id'>
        & { frontmatter?: Maybe<Pick<MdxFrontmatter, 'title'>>, headings?: Maybe<Array<Maybe<Pick<MdxHeadingMdx, 'depth' | 'value'>>>>, fields?: Maybe<Pick<MdxFields, 'slug'>> }
      ) }> } };
...
export type PostArchiveQueryQuery = { allMdx: { edges: Array<{ node: (
        Pick<Mdx, 'id'>
        & { frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'date' | 'tags'>>, fields?: Maybe<Pick<MdxFields, 'slug'>> }
      ) }> }, pageCount: { edges: Array<{ node: Pick<Mdx, 'id'> }> } };
...
export type Unnamed_3_Query = { mdx?: Maybe<(
    Pick<Mdx, 'body' | 'rawBody'>
    & { frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'date' | 'tags'>>, headings?: Maybe<Array<Maybe<Pick<MdxHeadingMdx, 'value'>>>> }
  )> };
